...
from nova.virt.solariszones.volume_api import SolarisVolumeAPI
...
#            instance['instance_type_id'])
    ...
    def _fetch_image(self, context, instance):
        ...
        with lockutils.lock('glance-image-%s' % iref):
            ...
            try:
                images.fetch(context, iref, downloading) # No trusted_certs for now
    ...
    def spawn(self, context, instance, image_meta, injected_files,
        ...
        if configdrive.required_by(instance):
            ...
            with configdrive.ConfigDriveBuilder(instance_md=instance_md) as cd:
                ...
                try:
                    ...
                    LOG.warning(_("Failed to create config drive '%s'" % cd_path))
        ...
        try:
            ...
            LOG.debug("About to delete volume %s, %s, %s", connection_info, context, volume_id)
            if connection_info is not None:
